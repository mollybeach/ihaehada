...
.cyan-blue-background {
    ...
    border: 5px solid #9dc9c1 !important;
    border-radius: 16px;
}
...
.cyanBlue--text textarea {
    caret-color: #9dc9c1 !important;
}
.cyanBlue--after:after {
    background: #9dc9c1 !important;
}
.cyanBlue.lighten-5 {
